(function () {
    ...
    angular.module('panhandler', [])
      .directive('panhandler', ['$document',function($document) {
          ...
          return {
              ...
              link: function link(scope, element, attr) {
                  setTimeout(function () {
                      new Panhandler(element, attr, scope, $document);
                  });
              }
          };
      }]);

    var Panhandler =  function ($el, attr, $scope, $document) {
        this.$el = $el;
    ...
    Panhandler.prototype = {
        ...
        startDrag: function (e) {
            ...
            this.cacheBounds();
            this.grabbingCursor();
            this.$document.on(this.moveEvent, this.updateBind);
            this.$document.on(this.upEvent, this.endBind);
        ...
        endDrag: function () {
            ...
            this.curr = [];
            this.grabCursor();
            this.$document.off(this.moveEvent, this.updateBind);
            this.$document.off(this.upEvent, this.endBind);
    ...
    //    if (!window.cancelAnimationFrame)z
