...
! function () {
    ...
    n.controller("errorDialogCtrl", ["$scope", "$modalInstance", "$translate", "data", function (a, n, e, s) {
        ...
        var a = !0,
            ...
            r = function (s) {
                var t = {};
                return s = s || {}, t.kb = angular.isDefined(s.keyboard) ? s.keyboard : n, t.bd = angular.isDefined(s.backdrop) ? s.backdrop : a, t.ws = angular.isDefined(s.size) && (angular.equals(s.size, "sm") || angular.equals(s.size, "lg") || angular.equals(s.size, "md") || angular.equals(s.size, "xl")) ? s.size : l, t.wc = angular.isDefined(s.windowClass) ? s.windowClass : e, t
            };
