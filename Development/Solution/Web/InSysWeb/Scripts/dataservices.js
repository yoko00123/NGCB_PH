...
define(['app'], function (app) {
    ...
    var dataService = function (h, q, u) {
        ...
        //view and clear notication joshua cordova
        dataFactory.dropNotifications = function (refID) {
            return h({
                method: 'POST',
                url: serviceBase + 'DropNotifications',
                data: { "refID": refID },
                dataType: "json",
                disableInterceptor: true,
                ignoreLoadingBar: true
        ...
        dataFactory.clearNotification = function (refID) {
            return h({
                method: 'POST',
                url: serviceBase + 'clearNotification',
                data: { "refID": refID },
                dataType: "json",
                disableInterceptor: true,
                ignoreLoadingBar: true
