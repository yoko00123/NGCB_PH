...
#End Region
    ...
    Private Sub GenTemplate(ByVal sender As Object, ByVal e As EventArgs)
        ...
        If sfd.ShowDialog = Windows.Forms.DialogResult.OK Then
            ...
            Dim HDT As DataTable = GSCOM.SQL.TableQuery("SELECT 'Code', 'Working Hours' , 'No. of Days', 'Shift Type' ", Connection)
            Dim DT As DataTable = GSCOM.SQL.TableQuery("SELECT Code , WorkingHours, Days, ShiftType FROM dbo.fDailySchedule(" & myDT.Get(Database.Tables.tScheduleFile.Field.ID).ToString & ")", Connection)
