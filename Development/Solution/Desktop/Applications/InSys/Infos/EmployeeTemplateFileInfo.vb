...
Friend Class EmployeeTemplateFileInfo
    ...
    Private mtEmployeeTemplateFileDetail_PersonaBeneficiaries As GSCOM.SQL.ZDataTable
    ...
    Public Sub New(ByVal pMenu As Integer, ByVal c As SqlClient.SqlConnection, ByVal pListing As DataTable, ByVal pID As Integer)
        ...
        mtEmployeeTemplateFileDetail_PersonaBeneficiaries = DirectCast(Me.mDataset.Tables("tEmployeeTemplateFileDetail_PersonaBeneficiaries"), GSCOM.SQL.ZDataTable)
        ...
        ' mGrid = Me.GetDataGridView(mtEmployeeTemplateFileDetail_PersonaBeneficiaries)
...
#End Region
    ...
    Private Sub TransferExcelData(ByVal FileName As String)
        ...
        Try
            ...
            Me.EndProcess()
            ''---------------------------------------------------------------
            REM Persona Beneficiaries

            'Dim pb As String
            'pb = GetSelectString_PersonaBeneficiaries()
            'pb = "*"
            'GSCOM.SQL.GetExcelTable(FileName, "PersonaBeneficiaries", mtEmployeeTemplateFileDetail_PersonaBeneficiaries, pb)

            'mtEmployeeTemplateFileDetail_PersonaBeneficiaries.AcceptChanges()
            'For Each dr As DataRow In mtEmployeeTemplateFileDetail_PersonaBeneficiaries.Select()
            '    If dr.RowState = DataRowState.Unchanged Then ' SetAdded is for Unchangeds only
            '        dr.SetAdded()
            '    End If
            'Next
            'mGrid.DataSource = mtEmployeeTemplateFileDetail_PersonaBeneficiaries
            'Me.EndProcess()
            ''---------------------------------------------------------------
    ...
    Private Function GetSelectString_Company() As String
        ...
        c &= ", " & Database.Tables.tEmployeeTemplateFileDetail_CompanyInfo.Field.ShiftType.ToString
        Return c
    End Function
    ...
    Private Function GetSelectString_PersonaBeneficiaries() As String
        Dim pb As String
        pb = Database.Tables.tEmployeeTemplateFileDetail_PersonaBeneficiaries.Field.EmployeeCode.ToString
        pb &= ", " & Database.Tables.tEmployeeTemplateFileDetail_PersonaBeneficiaries.Field.LastName.ToString
        pb &= ", " & Database.Tables.tEmployeeTemplateFileDetail_PersonaBeneficiaries.Field.FirstName.ToString
        pb &= ", " & Database.Tables.tEmployeeTemplateFileDetail_PersonaBeneficiaries.Field.MiddleName.ToString
        pb &= ", " & Database.Tables.tEmployeeTemplateFileDetail_PersonaBeneficiaries.Field.BeneficiaryType.ToString
        pb &= ", " & Database.Tables.tEmployeeTemplateFileDetail_PersonaBeneficiaries.Field.Relationship.ToString
        pb &= ", " & Database.Tables.tEmployeeTemplateFileDetail_PersonaBeneficiaries.Field.Birthdate.ToString
        pb &= ", " & Database.Tables.tEmployeeTemplateFileDetail_PersonaBeneficiaries.Field.PercentageShare.ToString
        pb &= ", " & Database.Tables.tEmployeeTemplateFileDetail_PersonaBeneficiaries.Field.IsRevocable.ToString
