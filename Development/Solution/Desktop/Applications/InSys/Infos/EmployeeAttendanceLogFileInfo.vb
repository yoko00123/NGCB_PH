...
#Region "ImportFile"
    ...
    Private Sub ImportLogFile(ByVal sender As Object, ByVal e As EventArgs)
        ...
        ofd.Filter = "Excel Files|*.xls;*.xlsx;|Log Files|*.log;|Fscan Backup file|*.InSys;|USB backup file|*.dat;"
        ofd.FilterIndex = 0
            ...
            If ofd.ShowDialog() = Windows.Forms.DialogResult.OK Then
                ...
                Select Case System.IO.Path.GetExtension(ofd.FileName).ToUpper
                    ...
                    Case Else
                        ...
                        If ofd.FilterIndex = 4 Then
                            Try
                                sa = LogDecrypt.DecryptFile(ofd.FileName).Split(New String() {Environment.NewLine}, StringSplitOptions.None)
                                If sa.Length <= 1 Then
                        ...
                        Select Case System.IO.Path.GetExtension(ofd.FileName).ToUpper
                            ...
                            Case ".INSYS" '2 'FSCAN Log
                                ...
                                For Each s In sa
                                    ...
                                    vSource = (a(0))
                                    dr(Database.Tables.tEmployeeAttendanceLog.Field.Source.ToString) = vSource 'Added Source for NGCB Policy hbb20180123
                                    ...
                                    Dim inout As Int32  'For LogType hanabi20180403
                                    If CInt(a(3)) = 0 Then
                                        inout = 1
                                    ElseIf CInt(a(3)) = 1 Then
                                        inout = 2
                                    ElseIf CInt(a(3)) = 2 Then
                                        inout = 3
                                    ElseIf CInt(a(3)) = 3 Then
                                        inout = 4
                                    ElseIf CInt(a(3)) = 4 Then
                                        inout = 5
                                    Else
                                        inout = 6
                                    End If
        ...
        Try
            ...
            If sfd.ShowDialog() = Windows.Forms.DialogResult.OK Then
                ...
                For Each dr As DataRow In dt.Select
                    Source = CInt(dr.Item(Database.Tables.tEmployeeAttendanceLogFile_Unapplied.Field.Source.ToString)) 'Added Source for NGCB Policy hbb20180123
...
#Region "Exce File"
        ...
        Try
            ...
            Using dtattlog As DataTable = GetAttendanceTable()
                ...
                For Each dr As DataRow In dtattlog.Rows
                    ...
                    idr("ID_AttendanceLogType") = dr("ID_AttendanceLogType") 'To identify Attendance Log Type in Exce file -hana20170505
    ...
    Private Function GetAttendanceTable() As DataTable
        ...
        dt.Columns.Add("ID_AttendanceLogType", GetType(Int32)) 'To identify Attendance Log Type in Exce file -hana20170505
        Return dt
    End Function
    ...
    Private Function GetSelectString() As String
        ...
        s &= ", " & Database.Tables.tEmployeeAttendanceLog.Field.ID_AttendanceLogType.ToString 'To identify Attendance Log Type in Exce file -hana20170505
        Return s
    End Function
#End Region
