...
#Region "tEmployeeTemplateFileDetail_PersonaBeneficiaries"

    Public Class tEmployeeTemplateFileDetail_PersonaBeneficiaries
        Inherits GSCOM.SQL.ZDataTable
        ...
        Public Sub New(ByVal c As SqlClient.SqlConnection)
            MyBase.New(c, "tEmployeeTemplateFileDetail_PersonaBeneficiaries")
        End Sub
